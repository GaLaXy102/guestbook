...
public class Application {
	...
	CommandLineRunner init(GuestbookRepository guestbook) {
		...
		return args -> {
			...
			Stream.of( //
					new GuestbookEntry("H4xx0r", "h4xx0r@pw.nd", "first!!!"), //
					new GuestbookEntry("Arni", "schwarzenegger.arnold@kellertreff.at", "Hasta la vista, baby"), //
					new GuestbookEntry("Duke Nukem", "dn3d@3drealms.com", "It's time to kick ass and chew bubble gum. And I'm all out of gum."), //
					new GuestbookEntry("Gump1337", "forrest@gump.net",
